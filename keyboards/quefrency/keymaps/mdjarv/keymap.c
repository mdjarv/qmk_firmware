...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
    ...
    KC_LCTL,  KC_LGUI, KC_LALT, MO(_FN1),KC_SPC,           KC_SPC,  KC_RALT, XXXXXXX, KC_RGUI, XXXXXXX, KC_APP, KC_RCTL
  ),

  [_FN1] = LAYOUT(
    KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______,  KC_DEL, \
    _______, RGB_MOD, _______, KC_UP,   _______, _______, _______, KC_PGUP, KC_UP,   KC_PGDN, _______, _______, _______, _______, \
    _______, KC_MUTE, KC_VOLD, KC_VOLU, KC_MPLY, _______, KC_HOME, KC_LEFT, KC_DOWN, KC_RGHT, KC_INS, _______, _______,\
